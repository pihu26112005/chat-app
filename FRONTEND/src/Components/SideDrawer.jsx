...
const SideDrawer = () => {
  ...
  const { setSelectedChat, user, notification, setNotification, chats, setChats, } = useContext(SharedContext);
          ...
          <Menu>
            <MenuButton p={1}>
              {/* <NotificationBadge
                ...
                effect={Effect.SCALE}
              /> */}
              {notification.length >0 &&  <NotificationBadge count={notification.length} />}
